            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="loginform" action="{{route('admin.login')}}" method="POST">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" name="email" type="text" required="" placeholder="اسم المستخدم.."> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" name="password" type="password" required="" placeholder="كلمه السر.."> </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            </div> <a href="javascript:void(0)" id="to-recover" class="text-muted float-right"><i class="fa fa-lock m-r-5"></i> هل نسيت كلمه السر؟</a> </div>
                    </div>
                    <div class="form-group text-center">
                        <div class="col-xs-12 p-b-20">
                            <button class="btn btn-block btn-lg btn-info btn-rounded" type="submit">تسجيل دخول</button>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            ليس لدي حساب <a href="pages-register.html" class="text-info m-l-5"><b>سجل</b></a>
                        </div>
                    </div>
                </form>
